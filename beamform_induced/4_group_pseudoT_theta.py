...
pseudoT_path = op.join(deriv_root, 'beamform_induced')
...
for s, subject in enumerate(subjects):
    ...
    for s, session in enumerate(sessions):
        ...
        stc_left_fname = deriv_path.basename + "-left_stim_theta"
        stc_right_fname = deriv_path.basename + "_right_stim_theta"
