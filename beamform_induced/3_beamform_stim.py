...
subject = '2001'
for session in ['01N', '03N', '05N', '06N']:
    ...
    stc_left_fname = deriv_path.basename + "-lh_theta_stc.npy"
    change_left.save(op.join(deriv_path.directory, stc_left_fname))
    stc_right_fname = deriv_path.basename + "-rh_theta_stc.npy"
    change_right.save(op.join(deriv_path.directory, stc_right_fname))
    
    #%% extract peak response in label(s) LEFT HAND
    
    # create generator
    stc_epochs = mne.beamformer.apply_lcmv_epochs(epochs["102"], filters,
    ...
    lh_response_fname = deriv_path.basename + "-lh_stim_theta.npy"
    ...
    # create generator
    stc_epochs = mne.beamformer.apply_lcmv_epochs(epochs["101"], filters,
                                                  return_generator=True)
    ...
    rh_response_fname = deriv_path.basename + "-rh_stim_theta.npy"
