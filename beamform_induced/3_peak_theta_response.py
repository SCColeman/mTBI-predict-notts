# -*- coding: utf-8 -*-
"""
Create LCMV beamformer and localise oscillatory activity in a CRT task.
...
out_folder = op.join(deriv_root, 'beamform_induced')
...
# save pseudo T
pseudoT_left_fname = deriv_path.basename + "-left_stim_theta"
pseudoT_left.save(op.join(out_folder, pseudoT_left_fname), overwrite=True)
pseudoT_right_fname = deriv_path.basename + "-right_stim_theta"
...
lh_source_fname = deriv_path.basename + "-lh_theta_source.fif"
...
# save peak source epoch
rh_source_fname = deriv_path.basename + "-rh_theta_source.fif"
